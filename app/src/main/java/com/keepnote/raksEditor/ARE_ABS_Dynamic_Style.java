 ...
 * @param <E>
 */
public abstract class ARE_ABS_Dynamic_Style<E extends AreForegroundColorSpan> extends RREABSStyle<E> {
    ...
    protected void applyNewStyle(Editable editable, int start, int end, int currentStyle) {
        ...
        E[] existingSpans = editable.getSpans(detectStart, detectEnd, getClazzE());
    ...
    protected void extendPreviousSpan(Editable editable, int pos) {
        E[] pSpans = editable.getSpans(pos, pos, getClazzE());
    ...
    public interface RreDynamicSpan {
