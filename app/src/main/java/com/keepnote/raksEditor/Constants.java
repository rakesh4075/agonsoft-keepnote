...
public class Constants {
   // public static final int CHECKED_COLOR = 0XffFF4081; // android.R.color.holo_green_light;
    ...
    //public static final int CHECKED_COLOR = 0XFFFFCC80; // android.R.color.holo_green_light;

    public static final int CHECKED_COLOR = 0xFFF05A50; // android.R.color.holo_green_light;
