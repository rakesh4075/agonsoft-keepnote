...
public class ColorPickerView extends HorizontalScrollView {
    ...
    public ColorPickerView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        mAttributeBundle.putInt("ATTR_VIEW_WIDTH", mColorViewWidth);
        mAttributeBundle.putInt("ATTR_VIEW_HEIGHT", mColorViewWidth);
        mAttributeBundle.putInt("ATTR_MARGIN_LEFT", mColorViewMarginLeft);
        mAttributeBundle.putInt("ATTR_MARGIN_RIGHT", mColorViewMarginRight);
        mAttributeBundle.putInt("ATTR_CHECKED_TYPE", mColorCheckedViewType);
